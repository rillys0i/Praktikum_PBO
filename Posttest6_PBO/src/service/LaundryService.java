...
public class LaundryService {
    ...
    private final Notifikasi notifikasi = new NotifikasiConsole();
    ...
    private void buatPesanan() {
        ...
        while (true) {
            ...
            try {
                ...
                switch (jenisPilihan) {
                    case 1 -> jenisBarang = "pakaian";
                    case 2 -> jenisBarang = "sprei";
                    default -> {
    ...
    // Kirim notifikasi
    notifikasi.kirimNotifikasi("Pesanan baru dengan ID " + pesanan.getIdPesanan() + " berhasil dibuat!");
}
...
private void lihatPesananMahasiswa() {
    ...
    if (!adaPesanan) {
        ...
        // Kirim notifikasi jika tidak ada pesanan
        notifikasi.kirimNotifikasi("Mahasiswa dengan NIM " + loggedInMahasiswa.getNim() + " tidak memiliki pesanan.");
    } else {
        // Kirim notifikasi ketika mahasiswa melihat pesanan
        notifikasi.kirimNotifikasi("Mahasiswa dengan NIM " + loggedInMahasiswa.getNim() + " telah melihat daftar pesanan mereka.");
    }
}
        ...
        while (true) {
            ...
            for (Pesanan p : pesananList) {
                if (p.getIdPesanan().equals(id)) {
                    ...
                    // Kirim notifikasi
                    notifikasi.kirimNotifikasi("Status pesanan " + id + " telah diperbarui menjadi: " + p.getStatus());
                    return;
                }
            }
    ...
    private void hapusPesanan() {
        ...
        // Kirim notifikasi
        notifikasi.kirimNotifikasi("Pesanan dengan ID " + id + " telah dihapus.");
    }
